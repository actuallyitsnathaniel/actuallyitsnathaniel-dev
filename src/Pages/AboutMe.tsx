      ...
      <div className="max-w-4xl px-6">
        ...
        <div className="text-2xl text-justify space-y-4">
          <p className="py-2">
            ...
            performant web applications using modern JavaScript frameworks. With a
            B.S. in Computer Science from Azusa Pacific University, I bring deep
            expertise in React, TypeScript, Node.js, and AWS cloud services to every
            project.
          </p>
          <p className="py-2">
            ...
            collaborative, Agile environments where critical thinking and creative
            problem-solving drive results.
          </p>
          <p className="py-2">
            My technical stack includes React, TypeScript, JavaScript, Node.js,
            Express, PostgreSQL, MongoDB, Firebase, AWS (Lambda, S3, CloudFront),
            Docker, Git, TailwindCSS, and responsive design principles. I'm passionate
            about writing clean, maintainable code and staying current with modern web
            development best practices.
          </p>
          <p className="py-2 font-bold">
            Available for full-time software engineering roles, freelance web
            development projects, and technical consulting. Whether you need a React
            developer, full-stack engineer, or AWS cloud architect, I deliver
            production-ready code that scales.
          </p>
        </div>

        <h3 className="text-4xl font-bold py-4 pt-8">BEYOND THE CODE</h3>
        <p className="text-2xl text-justify py-4 px-6">
