...
const Links = () => {
  ...
  return (
    <div className="flex flex-row duration-100 md:fixed md:bottom-0 md:left-0 justify-around content-stretch items-center md:hover:bottom-3 md:animate-none animate-mobile-links z-2 rounded-2xl md:overflow-hidden md:backdrop-blur-sm md:border md:border-gray-800 md:px-2 cursor-pointer">
