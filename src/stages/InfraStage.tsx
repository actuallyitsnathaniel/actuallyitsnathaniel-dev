...
const ROWS: InfraRow[] = [
  ...
  },
  {
    ...
    stat: "operational",
    desc: "migrated legacy applications to cloud-native aws infrastructure — ec2, ecs, and jumpbox architecture — delivering scalable, secure hosting environments across government clients.",
    metric: { v: "enterprise", qualitative: true, u: "ec2 · ecs · jumpbox" },
    aliases: ["aws", "ec2", "ecs", "jumpbox", "cloud", "migration", "modernization"],
  },
  {
    status: "green",
    name: "container registry",
    stat: "operational",
    desc: "docker containerization with nexus repository management — reproducible deployment builds across multiple project environments.",
    metric: { v: "enterprise", qualitative: true, u: "docker · nexus" },
    aliases: ["docker", "nexus", "container", "registry", "containerization", "build"],
  },
  {
    status: "green",
    name: "test coverage",
    stat: "operational",
    desc: "implemented jest testing framework across government-facing frontend codebases — enforced quality gate at the ci/cd pipeline level.",
    metric: { v: "90%+", u: "frontend coverage · jest" },
    aliases: ["jest", "testing", "coverage", "unit", "frontend", "quality"],
  },
  {
    status: "green",
    name: "508 compliance",
    stat: "operational",
    desc: "implemented section 508 accessibility improvements on government-facing applications — screen reader support, keyboard navigation, contrast compliance.",
    metric: { v: "enterprise", qualitative: true, u: "dhs · uscis clients" },
    aliases: ["508", "accessibility", "a11y", "wcag", "compliance", "government"],
  },
  {
    status: "green",
    name: "secrets management",
    stat: "operational",
    desc: "vault-based credential security across dev, staging, and production environments — no plaintext secrets in ci/cd pipelines.",
